...
model = dict(
    ...
    criteria=[
        ...
        # dict(type="FocalLoss", loss_weight=1.0, ignore_index=-1, alpha=[0.75, 0.1, 0.03, 0.01, 0.11]),
        dict(type="LovaszLoss", mode="multiclass", loss_weight=5.0, ignore_index=-1),
    ],
)
...
data_root = "datasets/pipe_data/480_patches"
